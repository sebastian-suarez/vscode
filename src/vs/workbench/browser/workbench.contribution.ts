	...
	registry.registerConfiguration({
		...
		'properties': {
			...
			[LayoutSettings.ACTIVITY_BAR_LOCATION]: {
				...
				// The macOS design puts the view switcher in the side bar header, where it
				// reads as a row of pills beside the window controls.
				'default': isMacintosh && isNative ? 'top' : 'default',
